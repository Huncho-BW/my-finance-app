...
export default function Transaction() {
  ...
  return (
    <section className="    parSection    ">
      ...
      <div className="mt-[32px] p-[20px]  bg-[white] relative ">
        <div className="  relative flex inputBord  justify-between">
          ...
          <div className=" flex sortIcon  md:gap-[24px] lg:gap-[24px]">
            <div className=" flex">
              ...
              <div ref={refSort} className="sortButton   ">
            ...
            <div className=" flex">
              ...
              <div ref={refFilter} className="catButton relative ">
        ...
        <div className=" mt-[20px] overflow-hidden chilBack  ">
        ...
        <div className=" mt-[20px] p-[10px] buttonbord bg-[white]  ">
